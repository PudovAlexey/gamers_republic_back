...
export class UserService {
  ...
  async createIser(userInput: CreateUserInput): Promise<UserEntity> {
  ...
  async removeUserById(id: number): Promise<number> {
    await this.userRepository.delete({ id });
    return id;
  }

  async updateUserById(updateUserInput: UpdateUserInput): Promise<UserEntity> {
